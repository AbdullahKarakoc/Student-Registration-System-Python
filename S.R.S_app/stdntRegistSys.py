...
def Save():
    ...
    if N=="" or C1=="Select Class" or D2=="" or Re1=="" or S1=="" or fathername=="" or mothername=="" or F1=="" or M1=="":
        ...
        registration_no()    #it will rechek registration no and reissue new no
...
def search():
    ...
    Clear()       #to clear all the data already available in the entry box and other
...
##            print(reg_number)
    ...
    #but reg_number just showing number after A2 lile 2,3,4 ...
    ...
    img=(Image.open("Student Images/"+str(x1)+".jpg"))      #we done this to take image name as registration no
    resized_image=img.resize((190,190))
    photo2=ImageTk.PhotoImage(resized_image)
    lbl.config(image=photo2)
    lbl.image=photo2
...
#Top frames
Label(root,text="Email: abdullahkrkc1453@gmail.com",width=10,heigh=3,bg="#f0687c",anchor='e').pack(side=TOP,fill=X)
Label(root,text="STUDENT REGISTRATION",width=10,heigh=2,bg="#c36464",fg='#fff',font='arial 20 bold').pack(side=TOP,fill=X)
...
Label(obj2,text="Moyher's Name:",font="arial 13",bg=framebg,fg=framefg).place(x=500,y=50)
